...
<html>
	...
	<div class="back2" style="display:inline;">
		...
		<div class="modoru">
			...
			<span class="logoutspan"><a href="logout">ログアウト</a></span>
		...
		<div class= "messagecomment">
			...
			<c:forEach items = "${messages}" var="message">
				...
				<div class="user-category">
					...
					<br>
						<span class = "category" align="right">カテゴリ︙<c:out value="${message.category }"/></span>
					<div class = "title-and-category">
						<span class = "title">件名︙<c:out value="${message.title }"/>
					...
					<div class = "commentForm">
						<form action="comment" method="post">
							<c:choose>
								...
								<c:otherwise>
									<textarea name="comment" cols="50" rows="1" class="tweet-box2"></textarea>
								</c:otherwise>
							</c:choose>
							<br>
				...
				<div class = "comments"  >
					<c:forEach items = "${comments}" var="comments">
						...
						<div class = "comment" >
							<div class="namedate">
								<span class="comment-name" align="left"><c:out value="${comments.name}"/> のコメント</span>
